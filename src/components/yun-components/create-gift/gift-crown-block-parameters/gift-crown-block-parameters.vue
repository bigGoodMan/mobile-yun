...
<template>
  <div class="gift-crown-block-parameters">
    ...
    <BottomPopup
      :columns="frontBackColumns"
      :show="frontBackShow"
      @trigger-confirm="obj => handleConfirm('car_speed_front_back', obj)"
      @trigger-close="frontBackShow = false"
    />
    <BottomPopup
      :columns="leftRightColumns"
      :show="leftRightShow"
      @trigger-confirm="obj => handleConfirm('car_speed_left_right', obj)"
      @trigger-close="leftRightShow = false"
    />
    <BottomPopup
      :columns="upDownColumns"
      :show="upDownShow"
      @trigger-confirm="obj => handleConfirm('car_speed_up_down', obj)"
      @trigger-close="upDownShow = false"
    />
  </div>
</template>
