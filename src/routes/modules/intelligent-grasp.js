...
const GraspEquipmentChoice = {
  ...
  component: () =>
    import(
      /* webpackChunkName: "GraspEquipmentChoice" */ "@v/intelligent-grasp/grasp-equipment-choice.vue"
    ),
  meta: {
    title: "选择设备"
  }
...
const GraspGiftChoice = {
  ...
  component: () =>
    import(
      /* webpackChunkName: "GraspGiftChoice" */ "@v/intelligent-grasp/grasp-gift-choice.vue"
    ),
  meta: {
    title: "选择礼品"
  }
