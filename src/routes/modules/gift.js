...
const AddEditGift = {
  ...
  name: 'add_edit_gift',
  component: () => import(/* webpackChunkName: "AddEditGift" */ '@v/create-gift/add-edit-gift.vue'),
  meta: {
...
const GiftStorageRecord = {
  ...
  component: () => import(/* webpackChunkName: "GiftStorageRecord" */ '@v/create-gift/gift-storage-record.vue'),
  meta: {
    title: '礼品入库记录'
  }
}
const AddGiftStorage = {
  ...
  component: () => import(/* webpackChunkName: "AddGiftStorage" */ '@v/create-gift/add-gift-storage.vue'),
  meta: {
    title: '新增礼品入库'
  }
}
const StoregeGiftAddList = {
  ...
  component: () => import(/* webpackChunkName: "StoregeGiftAddList" */ '@v/create-gift/storege-gift-add-list.vue'),
  meta: {
    title: '自建礼品列表',
    toTransition: 'slide-down',
    fromTransition: 'slide-up'
...
export default [ CreateGiftList, AddEditGift, CreateGiftDetail, GiftStorageRecord, AddGiftStorage, StoregeGiftAddList ]
