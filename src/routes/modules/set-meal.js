...
const ConsumptionPackage = {
  ...
  component: () =>
    import(
      /* webpackChunkName: "ConsumptionPackage" */ "@v/set-meal/consumption-package.vue"
    ),
  meta: {
    title: "消费套餐",
...
const MachineConsumptionMeal = {
  ...
  component: () =>
    import(
      /* webpackChunkName: "MachineConsumptionMeal" */ "@v/set-meal/machine-consumption-meal.vue"
    ),
  meta: {
    title: "机台套餐配置"
  }
...
const RechargePackage = {
  ...
  component: () =>
    import(
      /* webpackChunkName: "RechargePackage" */ "@v/set-meal/recharge-package.vue"
    ),
  meta: {
    title: "充值套餐",
...
const ExperienceTicket = {
  ...
  component: () =>
    import(
      /* webpackChunkName: "ExperienceTicket" */ "@v/set-meal/experience-ticket.vue"
    ),
  meta: {
    title: "门店体验券",
