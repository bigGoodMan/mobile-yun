...
const TrainingCampHome = {
  ...
  component: () =>
    import(
      /* webpackChunkName: "TrainingCampHome" */ "@v/training-camp/home.vue"
    ),
  meta: {
...
const TrainingCampCollect = {
  ...
  component: () =>
    import(
      /* webpackChunkName: "TrainingCampCollect" */ "@v/training-camp/collect.vue"
    ),
  meta: {
    goHome: "TrainingCampHome",
    tabBar: true
...
const TrainingCampSearch = {
  ...
  component: () =>
    import(
      /* webpackChunkName: "TrainingCampSearch" */ "@v/training-camp/search.vue"
    ),
  meta: {
    goHome: "TrainingCampHome",
    tabBar: true
...
const TrainingCampColumn = {
  ...
  component: () =>
    import(
      /* webpackChunkName: "TrainingCampColumn" */ "@v/training-camp/column.vue"
    ),
  meta: {
    goHome: "TrainingCampHome",
    tabBar: true
...
const LearningManual = {
  ...
  component: () =>
    import(
      /* webpackChunkName: "LearningManual" */ "@v/training-camp/learning-manual.vue"
    ),
  meta: {
    goHome: "TrainingCampHome",
    tabBar: true
...
const TrainingCampDetail = {
  ...
  component: () =>
    import(
      /* webpackChunkName: "TrainingCampDetail" */ "@v/training-camp/detail.vue"
    ),
  meta: {
    goHome: "TrainingCampHome",
    tabBar: true
