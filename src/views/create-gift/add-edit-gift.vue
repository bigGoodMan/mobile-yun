...
export default {
  ...
  methods: {
    ...
    handleSave() {
      let {
        basicParam: { default_earn_rate: defaultEarnRate },
        carParam: { line_length: lineLength },
        grabParam: {
      ...
      const {
        ...
        basicParam: { machine_type: machineType, claw_type: clawType },
        carParam: {
