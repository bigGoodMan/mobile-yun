...
<template>
  <div class="create-gift-detail">
    <div>
      <van-cell title="所属商家" :value="giftDetail.brand_name" />
    </div>
    ...
    <div class="margin-top-20 bgcolor-f">
      ...
      <div class="border border-ebedf0"></div>
      <div>
        <van-cell title="适用爪子" :value="clawType[giftDetail.claws_type]" />
      </div>
      <div class="border border-ebedf0"></div>
      <div>
        <van-cell title="预设毛利率" :value="giftDetail.default_earn_rate" />
      </div>
      <div class="size-22 color-7 create-gift-detail-tip">
    ...
    <div class="margin-top-20 bgcolor-f">
      ...
      <div class="border border-ebedf0"></div>
      <div>
        <van-cell title="绳长" :value="giftDetail.line_length" />
      </div>
    </div>
    <div class="margin-top-20 bgcolor-f">
      ...
      <div class="border border-ebedf0"></div>
      <div>
        <van-cell title="C1抓力" :value="giftDetail.grab_voltage" />
      </div>
      <div class="border border-ebedf0"></div>
      <div>
        <van-cell title="C2抓力" :value="giftDetail.fall_voltage" />
      </div>
      <div class="border border-ebedf0"></div>
      <div>
        <van-cell title="C3抓力" :value="giftDetail.after_fall_voltage" />
      </div>
      <div class="border border-ebedf0"></div>
      <div>
        <van-cell title="C4抓力" :value="giftDetail.vigorously_voltage" />
      </div>
    </div>
    <div class="margin-top-20 bgcolor-f">
      ...
      <div class="border border-ebedf0"></div>
      <div>
        <van-cell title="最大可抓取量" :value="giftDetail.can_claw_num" />
      </div>
      <div class="size-22 color-7 create-gift-detail-tip">
        该礼品可抓取区允许摆放的最大数
      </div>
      <div class="border border-ebedf0"></div>
      <div>
        <van-cell title="可抓取安全量" :value="giftDetail.can_claw_safe_num" />
      </div>
      <div class="size-22 color-7 create-gift-detail-tip">
        抓取区预警值，低于此值触发预警
      </div>
