    ...
    <div ckass="main">
      <div class="contaienr padding-20-30">
        ...
        >
          ...
          >
            <ul class="no-ul">
              <li class="padding-bottom-30" v-for="items of list" :key="items.id">
                <ExperienceTicketItem :itemData="items" @trigger-edit="handleEdit(items)" @trigger-take-effect="handleTakeEffect" @trigger-discontinue="handleDiscontinue" />
                </li>
            </ul>
          </van-list>
        </van-pull-refresh>
      </div>
      <HhfButton type="info" size="large" :bottom-z-index="10" radius="0.1rem" @trigger-click="handleAdd"
        >新增券包</HhfButton
      >
      <ExperienceTicketPopup v-model="show" :ticketData="ticketData" @trigger-save="handleSave"/>
