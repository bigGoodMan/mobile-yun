      ...
      >
        ...
        >
          <van-radio-group v-model="radio">
            <div v-for="(items, index) of columns" :key="index">
              <div
                :result="items"
              ...
              >
                ...
                ></van-radio>
                <div
                  class="flex-1 flex-row flex-between-stretch padding-left-10"
                >
                  ...
                  <div class="flex-row flex-end-center">
                    <van-tag :color="items.color1">{{
                      items.colorName1
                    }}</van-tag>
                    <van-tag :color="items.color2" class="tag-content">{{
                      items.colorName2
                    }}</van-tag>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    async getGraspGiftList() {
      ...
      const [err, res] = await errorCaptured(getGraspGiftListApi, {
        store_id: sid,
        page,
        status,
        limit,
    ...
    handleRefresh() {
      ...
      this.page = 1;
      this.finished = true;
      this.handleLoading(null, "fresh").then(() => {
