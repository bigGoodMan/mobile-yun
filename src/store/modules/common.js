import { getStoreApi, getAreaListByStoreApi, getMachineListByStoreAndAreaApi, getMachineTypeByStoreAndAreaApi } from '@/api'
export default {
  state: {
    storeList: [],
    area: {},
  ...
  actions: {
    ...
    async COMMON_GETMACHINETYPE_ACTION ({ commit, state }, { storeId, areaId }) {
      ...
      let res = await getMachineTypeByStoreAndAreaApi({ store_id: storeId, area_id: areaId })
